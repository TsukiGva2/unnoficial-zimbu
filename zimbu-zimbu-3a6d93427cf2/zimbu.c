/*
 * Generated from Zimbu file zimbu.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
/* ARGModule done */
/* including Arguments typedefs */
/* including CommonFlags typedefs */
...
extern Tto Y_SI__T;
/* ARGModule done */
/* including Arguments structs */
/* including CommonFlags structs */
...
Tb YG_U(Tc *Athis, Tc *As); /* MSTRINGModule.contains */
Tc *Yvnf(Tc *Athis, Ti Afrom, Ti Ato); /* MSTRINGModule.replaceAll */
Tc *Yvnfa(Tc *Athis, Tc *Afrom, Tc *Ato); /* MSTRINGModule.replaceAll */
...
Ts Yjcw__Ydti(Yjcw *t, Ti Achar); /* MIOModule__CByteWriter.writeChar__p1 */
Ts Yjcw__YRt7(Yjcw *t, Tc *Atext); /* MIOModule__CByteWriter.print__p1 */
Tc *Yjcw__mt[50];
Tc *Yjcw__YdXi_imt[3];
To ToYjcw[2];
Zs12 Yg9R = {"\012ByteWriter\000"};
To ToYPto[1];
...
void YzqH__YofP(YzqH *t, Tc *Aname, YuQR *Aflag, YkxB *Apos); /* MARGModule__CString.throwDuplicate__p1 */
YuQR *YzqH__Y836(YzqH *t, Tc *AargName); /* MARGModule__CString.setArgName__p1 */
...
void Y_SI__YofP(Y_SI *t, Tc *Aname, YuQR *Aflag, YkxB *Apos); /* MARGModule__CStringList.throwDuplicate__p1 */
YuQR *Y_SI__Y836(Y_SI *t, Tc *AargName); /* MARGModule__CStringList.setArgName__p1 */
...
/* ARGModule done */
/* including Arguments declarations */
/* including CommonFlags declarations */
...
void YFs_(YFL0 *Amsg, Tl *Afspecs, Tr AiReader); /* MProto.mergeFromTextFields */
...
Tb YPR3(YFL0 *A0, Ti A1, Te A2, Tr A3); /* YFL0_I__MmergeMessageFromReader_I__int__enumValue__YMd3_I */
/* Proto done */
...
Tc *YnT5(YNdL *t); /* MZimbu__CConfig.getPcreArg */
...
void YNdL__Y3p7(YNdL *t, Ti AfieldNr, Ti Avalue); /* MZimbu__CConfig.enumSet__p1 */
...
void YNdL__Yoxk(YNdL *t, Ti AfieldNr, Tc *Avalue); /* MZimbu__CConfig.bytesSet__p1 */
...
/* zimbuConfig done */
/* including TargetLang declarations */
Zs12 YopQ = {"\012TargetLang\000"};
Tt BTargetLang__T = {25, ((Tc*)&YopQ), 0};
/* TargetLang done */
...
Tc *Yojm = NULL; /* MConfig.pcreArg */
Tc *Yjm9 = NULL; /* MConfig.libPath */
Tc *YajM = NULL; /* MConfig.pluginPath */
Tc *YOu3 = NULL; /* MConfig.thirdpartyPath */
...
Zs11 YDq4 = {"\011profalloc\000"};
Zs53 Y2Hj = {"\063Profile memory allocations (slows down the program)\000"};
Y86c *YJa3 = 0; /* MConfig.profallocFlag */
Tb Yfck = 0; /* MConfig.profalloc */
Zs4 YsHb = {"\002cc\000"};
...
Zs7 YpP_ = {"\005javac\000"};
Zs22 YsyB = {"\024Java compiler to use\000"};
Zs14 Yh83 = {"\014javaCompiler\000"};
YzqH *Yvr6 = 0; /* MConfig.javaCompiler */
Zs9 Yx9s = {"\007javaarg\000"};
Zs37 YOGX = {"\043-Xlint:unchecked -Xlint:deprecation\000"};
Zs25 YaRa = {"\027Java compiler arguments\000"};
Zs15 YAKe = {"\015javaArguments\000"};
YzqH *YKXV = 0; /* MConfig.javaArguments */
Zs5 Y44v = {"\003jar\000"};
Zs20 YepT = {"\022jar command to use\000"};
YzqH *YXJ1 = 0; /* MConfig.jarCommand */
...
Zs12 Ydq5 = {"\012thirdparty\000"};
Zs18 YjgX = {"\020/zimbuConfig.out\000"};
Zs14 Yz5d = {"\014Cannot open \000"};
Tl *YuyT = NULL; /* MConfig.listeners */
Tc *YEL8(Tc *AsrcName, Tc *AbinName, Tbs AtargetLang); /* MConfig.compilerCmd */
Zs7 Yb1k = {"\005 -o \"\000"};
Zs4 Yb1 = {"\002\" \000"};
Zs7 Y3KT = {"\005 -d \"\000"};
Zs5 Yjmy = {"\003\" \"\000"};
Zs37 YLFt = {"\043compilerCmd(): unsupported language\000"};
Tc *YRe9(Tc *AbinName, Tl *AclassFiles); /* MConfig.jarCmd */
Zs6 YZAj = {"\004-C \"\000"};
Zs5 Yomy = {"\003\" '\000"};
Zs4 Yc9 = {"\002' \000"};
Zs6 YQZ4 = {"\004 cf \000"};
Zs7 Yj1q = {"\005.jar \000"};
int JConfig(int round);
/* Config done */
Zs3 Y6a = {"\001z\000"};
Zs11 YjUR = {"\011zeroundef\000"};
Zs58 YPXR = {"\070Skip resolving symbols if there are no undefined symbols\000"};
Y86c *YFnI = 0; /* MCommonFlags.undefinedFlag */
Zs4 YWSb = {"\002js\000"};
Zs31 Y7Ds = {"\035Produce a Javascript program.\000"};
Y86c *YX4y = 0; /* MCommonFlags.writeJsFlag */
Zs6 YvIV = {"\004java\000"};
Zs25 YtzM = {"\027Produce a Java program.\000"};
Y86c *Yji4 = 0; /* MCommonFlags.writeJavaFlag */
Zs12 Y5Ka = {"\012keepunused\000"};
Zs23 YAP6 = {"\025Do write unused items\000"};
Y86c *Y5HV = 0; /* MCommonFlags.keepUnusedFlag */
Zs21 YzNS = {"\023reportErrorInUnused\000"};
Zs43 Yb3W = {"\051Do report errors in code that is not used\000"};
Y86c *YaNI = 0; /* MCommonFlags.reportErrorInUnused */
Zs8 YBMJ = {"\006manage\000"};
Zs9 YpLJ = {"\007default\000"};
Zs57 Ysgh = {"\067Memory management method; one of: default, none, linked\000"};
YzqH *YpLr = 0; /* MCommonFlags.manageFlag */
Zs11 Yd5h = {"\011exitclean\000"};
Zs35 Yp3w = {"\041Run the garbage collector on exit\000"};
Y86c *YaSM = 0; /* MCommonFlags.exitclean */
Tc *Yh9t(); /* MCommonFlags.getArguments */
Zs5 Yzzt = {"\003 -q\000"};
Zs14 YpYE = {"\014 --profalloc\000"};
Zs5 YIzt = {"\003 -z\000"};
Zs7 YliG = {"\005 --js\000"};
Zs9 Yrtq = {"\007 --java\000"};
Zs15 YffS = {"\015 --keepunused\000"};
Zs24 YHmc = {"\026 --reportErrorInUnused\000"};
Zs13 Y8DJ = {"\013 --portable\000"};
Zs12 Ym79 = {"\012 --manage=\000"};
Zs14 YPir = {"\014 --exitclean\000"};
Zs7 Yd8v = {"\005 test\000"};
Zs4 Y0Y = {"\002 \"\000"};
int JCommonFlags(int round);
/* CommonFlags done */
Zs39 YCLg = {"\045Usage: %0% [--help] [flags] source.zu\000"};
YuMQ *Y_nT = 0; /* MArguments.usage */
Tb Yg2T = 0; /* MArguments.testMode */
Tc *YHc7 = NULL; /* MArguments.inFileName */
Tc *Yqnv = NULL; /* MArguments.rootName */
Tc *Y1Nd = NULL; /* MArguments.rootTail */
Tc *YYZY = NULL; /* MArguments.dirName */
Tc *YTTE = NULL; /* MArguments.zudirName */
Tc *YemS = NULL; /* MArguments.outFileName */
Tc *Yy7_ = NULL; /* MArguments.ecaFileName */
Tbs YDue(); /* MArguments.getTargetLang */
Zs42 Yw9J = {"\050Only --js or --java is allowed, not both\000"};
void YCrZ(Tbs AtargetLang); /* MArguments.parse */
Zs30 Y2hC = {"\034Missing source file argument\000"};
Zs6 YwNh = {"\004test\000"};
Zs27 Y0_a = {"\031Only one .zu file allowed\000"};
Zs5 YYv4 = {"\003.zu\000"};
Zs32 YaK9 = {"\036Input name must end in '.zu': \000"};
Zs5 Yh63 = {"\003.js\000"};
Zs7 YL8q = {"\005.java\000"};
Zs4 Yula = {"\002.c\000"};
Zs6 YGhR = {"\004.eca\000"};
Zs41 YxXA = {"\047Config failed, cannot compile a program\000"};
int JArguments(int round);
/* Arguments done */
Zs3 Y4a = {"\001x\000"};
...
YzqH *Vzimbu = 0;
Zs13 Yoy8 = {"\013interpreter\000"};
Zs8 Y6Qt = {"\006nodejs\000"};
Zs44 Yzy5 = {"\052Interpreter that runs the produced program\000"};
YzqH *Vinterpreter = 0;
Zs8 YTpk = {"\006.class\000"};
...
Zs12 YFOs = {"\012Javascript\000"};
Zs6 Y0V3 = {"\004Java\000"};
Zs3 Yea = {"\001C\000"};
Zs22 Yj_q = {"\024 program not written\000"};
Zs22 Y1n5 = {"\024Executing compiler: \000"};
Zs19 YQ7I = {"\021Compiled program \000"};
Zs15 YtjG = {"\015 is zero size\000"};
Zs18 YBGg = {"\020 was not updated\000"};
Zs23 Ym5P = {"\025Packing jar archive: \000"};
Zs7 YmdT = {"\005 -cp \000"};
Zs4 Y5Y = {"\002 '\000"};
Zs3 YN = {"\001'\000"};
Zs15 Yyp1 = {"\015Running tests\000"};
Zs19 YfLG = {"\021Executing program\000"};
Tl *YfV4(Tb AwithDir); /* matchingClasses */
...
Tc YKjM[]="Arguments.zu";
Tc Y7LC[]="CommonFlags.zu";
Tc YtPC[]="Config.zu";
...
Tc YKNl[]="Arguments.getTargetLang()";
Tcpos ZcTbl30766[]={
{31,5},
{1,7},
{4,5},
...
Tc YXDl[]="CommonFlags.getArguments()";
Tcpos ZcTbl80083[]={
{40,18},
{1,5},
{2,11},
...
Tc YNU7[]="IO.ByteWriter.print__p1/8()";
Tcpos ZcTbl48289[]={
{204,11},
{1,7},
{2,16},
...
Tc Y_Gg[]="IO.ByteWriter.writeChar__p1/1()";
Tcpos ZcTbl79630[]={
{195,11},
{1,7},
{2,9},
...
{51461,Yv00,YPAT,ZcTbl51461},
{52386,Yt1T,YgcM,ZcTbl52386},
{52648,YCG4,YF9k,ZcTbl52648},
{53377,Yt1T,Yp81,ZcTbl53377},
{53391,Yv00,YX0w,ZcTbl53391},
{53986,Yay0,Y39t,ZcTbl53986},
{54986,YtPC,YBfG,ZcTbl54986},
{55215,Y0hD,YmGw,ZcTbl55215},
{56360,YKjM,YXtC,ZcTbl56360},
...
{62972,YCG4,YFuG,ZcTbl62972},
{63102,Yay0,Y7vJ,ZcTbl63102},
...
{79630,Yay0,Y_Gg,ZcTbl79630},
{80083,Y7LC,YXDl,ZcTbl80083},
{80636,YCG4,YAAq,ZcTbl80636},
{80644,Yt1T,YobA,ZcTbl80644},
{80744,Y_hM,YhcO,ZcTbl80744},
...
{90354,YUV8,Y8dx,ZcTbl90354},
{90786,Y0dn,Y0q_,ZcTbl90786},
{92163,Yt1T,YTjU,ZcTbl92163},
{94823,Yay0,Yj_J,ZcTbl94823},
{96956,YxTh,Y8bQ,ZcTbl96956},
...
Tc *Ytlm__mt[] = {
 (Tc*)&Ytlm__T,
 (Tc*)0,
 (Tc*)offsetof(Ytlm, Vmessage), /* Vmessage */
 (Tc*)offsetof(Ytlm, Vpos), /* Vpos */
 (Tc*)offsetof(Ytlm, Vbacktrace), /* Vbacktrace */
...
To ToYtlm[] = {
 {3, 0},
 {offsetof(Ytlm, Vmessage), (Tt*)&string__T}, /* message */
 {offsetof(Ytlm, Vpos), (Tt*)&YkxB__T}, /* pos */
 {offsetof(Ytlm, Vbacktrace), (Tt*)&list__T}, /* backtrace */
};
...
Tc *YEro__mt[] = {
 (Tc*)&YEro__T,
 (Tc*)1,
 (Tc*)offsetof(YEro, Vmessage), /* Vmessage */
 (Tc*)offsetof(YEro, Vpos), /* Vpos */
 (Tc*)offsetof(YEro, Vbacktrace), /* Vbacktrace */
 ...
 (Tc*)0, /* MEModule__CExit.getMessage - YCzX */
 (Tc*)0, /* MEModule__CExit.getBacktrace - Y4bq */
 (Tc*)offsetof(YEro, Vvalue), /* Vvalue */
 (Tc*)YxaJa, /* MEModule__CExit.writeTo - YxaJa */
 (Tc*)YXHSa, /* MEModule__CExit.writeTo - YXHSa */
...
To ToYEro[] = {
 {3, 0},
 {offsetof(YEro, Vmessage), (Tt*)&string__T}, /* message */
 {offsetof(YEro, Vpos), (Tt*)&YkxB__T}, /* pos */
 {offsetof(YEro, Vbacktrace), (Tt*)&list__T}, /* backtrace */
};
...
Tc *YKhn__mt[] = {
 (Tc*)&YKhn__T,
 (Tc*)4,
 (Tc*)offsetof(YKhn, Vmessage), /* Vmessage */
 (Tc*)offsetof(YKhn, Vpos), /* Vpos */
 (Tc*)offsetof(YKhn, Vbacktrace), /* Vbacktrace */
...
To ToYKhn[] = {
 {3, 0},
 {offsetof(YKhn, Vmessage), (Tt*)&string__T}, /* message */
 {offsetof(YKhn, Vpos), (Tt*)&YkxB__T}, /* pos */
 {offsetof(YKhn, Vbacktrace), (Tt*)&list__T}, /* backtrace */
};
...
Tc *Y1uN__mt[] = {
 (Tc*)&Y1uN__T,
 (Tc*)5,
 (Tc*)offsetof(Y1uN, Vmessage), /* Vmessage */
 (Tc*)offsetof(Y1uN, Vpos), /* Vpos */
 (Tc*)offsetof(Y1uN, Vbacktrace), /* Vbacktrace */
...
To ToY1uN[] = {
 {3, 0},
 {offsetof(Y1uN, Vmessage), (Tt*)&string__T}, /* message */
 {offsetof(Y1uN, Vpos), (Tt*)&YkxB__T}, /* pos */
 {offsetof(Y1uN, Vbacktrace), (Tt*)&list__T}, /* backtrace */
};
...
Tc *YAxe__mt[] = {
 (Tc*)&YAxe__T,
 (Tc*)6,
 (Tc*)offsetof(YAxe, Vmessage), /* Vmessage */
 (Tc*)offsetof(YAxe, Vpos), /* Vpos */
 (Tc*)offsetof(YAxe, Vbacktrace), /* Vbacktrace */
...
To ToYAxe[] = {
 {3, 0},
 {offsetof(YAxe, Vmessage), (Tt*)&string__T}, /* message */
 {offsetof(YAxe, Vpos), (Tt*)&YkxB__T}, /* pos */
 {offsetof(YAxe, Vbacktrace), (Tt*)&list__T}, /* backtrace */
};
...
Tc *YVNj__mt[] = {
 (Tc*)&YVNj__T,
 (Tc*)7,
 (Tc*)offsetof(YVNj, Vmessage), /* Vmessage */
 (Tc*)offsetof(YVNj, Vpos), /* Vpos */
 (Tc*)offsetof(YVNj, Vbacktrace), /* Vbacktrace */
...
To ToYVNj[] = {
 {3, 0},
 {offsetof(YVNj, Vmessage), (Tt*)&string__T}, /* message */
 {offsetof(YVNj, Vpos), (Tt*)&YkxB__T}, /* pos */
 {offsetof(YVNj, Vbacktrace), (Tt*)&list__T}, /* backtrace */
};
...
Tc *Yalz__mt[] = {
 (Tc*)&Yalz__T,
 (Tc*)10,
 (Tc*)offsetof(Yalz, Vmessage), /* Vmessage */
 (Tc*)offsetof(Yalz, Vpos), /* Vpos */
 (Tc*)offsetof(Yalz, Vbacktrace), /* Vbacktrace */
...
To ToYalz[] = {
 {3, 0},
 {offsetof(Yalz, Vmessage), (Tt*)&string__T}, /* message */
 {offsetof(Yalz, Vpos), (Tt*)&YkxB__T}, /* pos */
 {offsetof(Yalz, Vbacktrace), (Tt*)&list__T}, /* backtrace */
};
...
Tc *Yw3O__mt[] = {
 (Tc*)&Yw3O__T,
 (Tc*)11,
 (Tc*)offsetof(Yw3O, Vmessage), /* Vmessage */
 (Tc*)offsetof(Yw3O, Vpos), /* Vpos */
 (Tc*)offsetof(Yw3O, Vbacktrace), /* Vbacktrace */
...
To ToYw3O[] = {
 {3, 0},
 {offsetof(Yw3O, Vmessage), (Tt*)&string__T}, /* message */
 {offsetof(Yw3O, Vpos), (Tt*)&YkxB__T}, /* pos */
 {offsetof(Yw3O, Vbacktrace), (Tt*)&list__T}, /* backtrace */
};
...
Tc *Y2EX__mt[] = {
 (Tc*)&Y2EX__T,
 (Tc*)12,
 (Tc*)offsetof(Y2EX, Vmessage), /* Vmessage */
 (Tc*)offsetof(Y2EX, Vpos), /* Vpos */
 (Tc*)offsetof(Y2EX, Vbacktrace), /* Vbacktrace */
...
To ToY2EX[] = {
 {3, 0},
 {offsetof(Y2EX, Vmessage), (Tt*)&string__T}, /* message */
 {offsetof(Y2EX, Vpos), (Tt*)&YkxB__T}, /* pos */
 {offsetof(Y2EX, Vbacktrace), (Tt*)&list__T}, /* backtrace */
};
...
Tc *YX0i__mt[] = {
 (Tc*)&YX0i__T,
 (Tc*)14,
 (Tc*)offsetof(YX0i, Vmessage), /* Vmessage */
 (Tc*)offsetof(YX0i, Vpos), /* Vpos */
 (Tc*)offsetof(YX0i, Vbacktrace), /* Vbacktrace */
...
To ToYX0i[] = {
 {3, 0},
 {offsetof(YX0i, Vmessage), (Tt*)&string__T}, /* message */
 {offsetof(YX0i, Vpos), (Tt*)&YkxB__T}, /* pos */
 {offsetof(YX0i, Vbacktrace), (Tt*)&list__T}, /* backtrace */
};
...
Tc *YP_P__mt[] = {
 (Tc*)&YP_P__T,
 (Tc*)15,
 (Tc*)offsetof(YP_P, Vmessage), /* Vmessage */
 (Tc*)offsetof(YP_P, Vpos), /* Vpos */
 (Tc*)offsetof(YP_P, Vbacktrace), /* Vbacktrace */
...
To ToYP_P[] = {
 {3, 0},
 {offsetof(YP_P, Vmessage), (Tt*)&string__T}, /* message */
 {offsetof(YP_P, Vpos), (Tt*)&YkxB__T}, /* pos */
 {offsetof(YP_P, Vbacktrace), (Tt*)&list__T}, /* backtrace */
};
...
Tc *YzSI__mt[] = {
 (Tc*)&YzSI__T,
 (Tc*)17,
 (Tc*)offsetof(YzSI, Vmessage), /* Vmessage */
 (Tc*)offsetof(YzSI, Vpos), /* Vpos */
 (Tc*)offsetof(YzSI, Vbacktrace), /* Vbacktrace */
...
To ToYzSI[] = {
 {3, 0},
 {offsetof(YzSI, Vmessage), (Tt*)&string__T}, /* message */
 {offsetof(YzSI, Vpos), (Tt*)&YkxB__T}, /* pos */
 {offsetof(YzSI, Vbacktrace), (Tt*)&list__T}, /* backtrace */
};
...
Tc *YXKl__mt[] = {
 (Tc*)&YXKl__T,
 (Tc*)19,
 (Tc*)offsetof(YXKl, Vmessage), /* Vmessage */
 (Tc*)offsetof(YXKl, Vpos), /* Vpos */
 (Tc*)offsetof(YXKl, Vbacktrace), /* Vbacktrace */
...
To ToYXKl[] = {
 {3, 0},
 {offsetof(YXKl, Vmessage), (Tt*)&string__T}, /* message */
 {offsetof(YXKl, Vpos), (Tt*)&YkxB__T}, /* pos */
 {offsetof(YXKl, Vbacktrace), (Tt*)&list__T}, /* backtrace */
};
...
Tc *YuDC__mt[] = {
 (Tc*)&YuDC__T,
 (Tc*)24,
 (Tc*)offsetof(YuDC, Vmessage), /* Vmessage */
 (Tc*)offsetof(YuDC, Vpos), /* Vpos */
 (Tc*)offsetof(YuDC, Vbacktrace), /* Vbacktrace */
...
To ToYuDC[] = {
 {3, 0},
 {offsetof(YuDC, Vmessage), (Tt*)&string__T}, /* message */
 {offsetof(YuDC, Vpos), (Tt*)&YkxB__T}, /* pos */
 {offsetof(YuDC, Vbacktrace), (Tt*)&list__T}, /* backtrace */
};
...
Tc *YrHq__mt[] = {
 (Tc*)&YrHq__T,
 (Tc*)26,
 (Tc*)offsetof(YrHq, Vmessage), /* Vmessage */
 (Tc*)offsetof(YrHq, Vpos), /* Vpos */
 (Tc*)offsetof(YrHq, Vbacktrace), /* Vbacktrace */
...
To ToYrHq[] = {
 {3, 0},
 {offsetof(YrHq, Vmessage), (Tt*)&string__T}, /* message */
 {offsetof(YrHq, Vpos), (Tt*)&YkxB__T}, /* pos */
 {offsetof(YrHq, Vbacktrace), (Tt*)&list__T}, /* backtrace */
};
...
To ToYkxB[] = {
 {2, 0},
 {offsetof(YkxB, Vfilename), (Tt*)&string__T}, /* filename */
 {offsetof(YkxB, Vtext), (Tt*)&string__T}, /* text */
};
...
Tc *Yvnfa(Tc *Athis, Tc *Afrom, Tc *Ato) { /* MSTRINGModule.replaceAll */
 ...
 if ((Vi >= 0))
 {
  ...
  while ((Vi >= 0))
  {
   ...
   {
    sf.pos=5339107;
    YJqza((YjUM *)Vw, ZstringSliceWrap(Athis, VnextChar, (Vi - 1)));
   }
   sf.pos=5339108;
   YJqza((YjUM *)Vw, Ato);
   sf.pos=5339109;
   VnextChar = (Vi + ZstringSize(Afrom));
   sf.pos=5339110;
   Vi = ZstringFind2(Athis, Afrom, VnextChar, 0);
  sf.pos=5339111;
  }
  sf.pos=5339112;
  YJqza((YjUM *)Vw, ZstringSliceWrap(Athis, VnextChar, -1));
  sf.pos=5339113;
  r = YbNW((YjUM *)Vw);
  rt = 1;
  goto YNah;
...
To ToYrC3[] = {
 {2, 0},
 {offsetof(YrC3, Vreader), (Tt*)&iobj__T}, /* reader */
 {offsetof(YrC3, Vstack), (Tt*)&list__T}, /* stack */
};
...
Tc *YjUM__mt[] = {
 ...
 (Tc*)0, /* MIOModule__CStringWriter.print - YjUM__YRt7g */
 (Tc*)0, /* MIOModule__CStringWriter.format - YjUM__YTPv */
 (Tc*)offsetof(YjUM, VsLen), /* VsLen */
 (Tc*)offsetof(YjUM, Vs), /* Vs */
 (Tc*)0, /* Vx */
...
To ToYjUM[] = {
 {1, 0},
 {offsetof(YjUM, Vs), (Tt*)&array__T}, /* s */
};
...
Ts Yjcw__YRt7(Yjcw *t, Tc *Atext) { /* MIOModule__CByteWriter.print__p1 */
 ...
 sf.pos=4828901;
 if (((Yp79a(t, Atext) == 1) && (Yp79a(t, ((Tc*)&Yk)) == 1)))
 {
  sf.pos=4828902;
  r = 1;
  rt = 1;
...
Tc *Yjcw__mt[] = {
 (Tc*)&Yjcw__T,
 (Tc*)4,
 (Tc*)0, /* MIOModule__CByteWriter.write - Yjcw__YHhZg */
 (Tc*)0, /* MIOModule__CByteWriter.write - Yjcw__YHhZf */
 (Tc*)0, /* MIOModule__CByteWriter.write - Yjcw__YHhZe */
 (Tc*)0, /* MIOModule__CByteWriter.write - Yjcw__YHhZd */
 (Tc*)0, /* MIOModule__CByteWriter.write - Yjcw__YHhZc */
 (Tc*)0, /* MIOModule__CByteWriter.write - Yjcw__YHhZb */
 (Tc*)Yp79c, /* MIOModule__CByteWriter.write - Yp79c */
 (Tc*)Yp79a, /* MIOModule__CByteWriter.write - Yp79a */
 (Tc*)0, /* MIOModule__CByteWriter.writeByte - Ypnua */
 (Tc*)Yjcw__Ydti, /* MIOModule__CByteWriter.writeChar - Yjcw__Ydti */
 (Tc*)0, /* MIOModule__CByteWriter.print - Yjcw__YRt7g */
 (Tc*)0, /* MIOModule__CByteWriter.print - Yjcw__YRt7f */
 (Tc*)0, /* MIOModule__CByteWriter.print - Yjcw__YRt7e */
 (Tc*)0, /* MIOModule__CByteWriter.print - Yjcw__YRt7d */
 (Tc*)0, /* MIOModule__CByteWriter.print - Yjcw__YRt7c */
 (Tc*)0, /* MIOModule__CByteWriter.print - Yjcw__YRt7b */
 (Tc*)0, /* MIOModule__CByteWriter.print - Yjcw__YRt7a */
 (Tc*)Yjcw__YRt7, /* MIOModule__CByteWriter.print - Yjcw__YRt7 */
 (Tc*)0, /* MIOModule__CByteWriter.format - Yjcw__YTPv */
 (Tc*)0, /* Init - Yjcwa */
 (Tc*)Yp79c, /* MIOModule__CByteWriter.write - Yp79c */
 (Tc*)Yp79a, /* MIOModule__CByteWriter.write - Yp79a */
 (Tc*)0, /* MIOModule__CByteWriter.write - Yjcw__YHhZb */
 ...
 (Tc*)0, /* MIOModule__CByteWriter.print - Yjcw__YRt7g */
 (Tc*)0, /* MIOModule__CByteWriter.format - Yjcw__YTPv */
 (Tc*)offsetof(Yjcw, VsLen), /* VsLen */
 (Tc*)offsetof(Yjcw, Vs), /* Vs */
 (Tc*)0, /* Vx */
 (Tc*)0, /* MIOModule__CByteWriter.Size - YLDW */
 (Tc*)0, /* MIOModule__CByteWriter.size - YgR4 */
 (Tc*)Y8Km, /* MIOModule__CByteWriter.toByteString - Y8Km */
 (Tc*)0, /* MIOModule__CByteWriter.remove - YAD2 */
 (Tc*)0, /* MIOModule__CByteWriter.truncate - YFK2 */
 (Tc*)0, /* Init - Yjcwa */
};
Tc *Yjcw__YdXi_imt[] = {
 (Tc*)&Yjcw__T,
...
To ToYjcw[] = {
 {1, 0},
 {offsetof(Yjcw, Vs), (Tt*)&array__T}, /* s */
};
...
Tc *Yr6O(Tc *AexeName, Tc *AnewName) { /* MIOModule.modifyExeName */
 ...
 sf.pos=2890201;
 Vresult = (((VtailIdx > 0)) ? (YuALa(AexeName, 0, (VtailIdx - 1))) : (((Tc*)&Ya)));
 sf.pos=2890202;
 ...
 {
  sf.pos=2890205;
  Vresult =  ZcS(Vresult, YuAL(AexeName, VdotIndex));
 }
 sf.pos=2890206;
 r = Vresult;
 topFrame = sf.prev;
...
Tc *Yfmf() { /* MLOGModule.getFlags */
 ...
 sf.pos=1178603;
 {
  Ti Vi;
  Tfr Zf1;
  ZforRangeNew(1, Y86c__Ye9f((Y86c *)YlUb), 0, 1, &Zf1);
  for (ZforRangeGetInt(&Zf1, &Vi); ZforRangeContInt(&Zf1); ZforRangeNextInt(&Zf1, &Vi)) {
  sf.pos=1178604;
...
void YS39() { /* MARGModule.notInitCheck */
 ...
 {
  Ytlm *ex;
  ex = (Ytlm*)YVNj__YwtA__YRHRa(NULL, MZ__callerPos(), ((Tc*)&YY2Q));
  ZthrowIobject(ex);
 }
 return;
}
...
YuMQ *YOHU(YuMQ *t, Tc *Atext) { /* MARGModule__CUsage.NEW */
 ...
 if ((Yun4 != NULL))
 {
  Ytlm *ex;
  sf.pos=6751403;
  ex = (Ytlm*)YVNj__YwtA__YRHR(NULL, ((Tc*)&YAn1));
  ZthrowIobject(ex);
 }
 sf.pos=6751404;
 Yun4 = t;
...
To ToYuMQ[] = {
 {1, 0},
 {offsetof(YuMQ, Vtext), (Tt*)&string__T}, /* text */
};
...
Tc *Y86c__mt[] = {
 (Tc*)&Y86c__T,
 (Tc*)1,
 (Tc*)offsetof(Y86c, VshortName), /* VshortName */
 (Tc*)offsetof(Y86c, VlongName), /* VlongName */
 (Tc*)offsetof(Y86c, Vdoc), /* Vdoc */
 (Tc*)offsetof(Y86c, VargName), /* VargName */
 (Tc*)offsetof(Y86c, VsetCount), /* VsetCount */
 (Tc*)offsetof(Y86c, VcanRepeat), /* VcanRepeat */
 (Tc*)offsetof(Y86c, VnoCompactVal), /* VnoCompactVal */
 (Tc*)offsetof(Y86c, VargOpt), /* VargOpt */
 (Tc*)offsetof(Y86c, Vpos), /* Vpos */
 ...
 (Tc*)Y86c__Ye9f, /* MARGModule__CBool.presentCount - Y86c__Ye9f */
 (Tc*)Y86c__Y8Dq, /* MARGModule__CBool.present - Y86c__Y8Dq */
 (Tc*)offsetof(Y86c, Vcurrent), /* Vcurrent */
 (Tc*)offsetof(Y86c, Vdefault), /* Vdefault */
 (Tc*)YEqoa, /* MARGModule__CBool.setToDefault - YEqoa */
...
To ToY86c[] = {
 {5, 0},
 {offsetof(Y86c, VshortName), (Tt*)&string__T}, /* shortName */
 {offsetof(Y86c, VlongName), (Tt*)&string__T}, /* longName */
 {offsetof(Y86c, Vdoc), (Tt*)&string__T}, /* doc */
 {offsetof(Y86c, VargName), (Tt*)&string__T}, /* argName */
 {offsetof(Y86c, Vpos), (Tt*)&YkxB__T}, /* pos */
};
...
Tc *YJQu__mt[] = {
 (Tc*)&YJQu__T,
 (Tc*)2,
 (Tc*)offsetof(YJQu, VshortName), /* VshortName */
 (Tc*)offsetof(YJQu, VlongName), /* VlongName */
 (Tc*)offsetof(YJQu, Vdoc), /* Vdoc */
 (Tc*)offsetof(YJQu, VargName), /* VargName */
 (Tc*)offsetof(YJQu, VsetCount), /* VsetCount */
 (Tc*)offsetof(YJQu, VcanRepeat), /* VcanRepeat */
 (Tc*)offsetof(YJQu, VnoCompactVal), /* VnoCompactVal */
 (Tc*)offsetof(YJQu, VargOpt), /* VargOpt */
 (Tc*)offsetof(YJQu, Vpos), /* Vpos */
 ...
 (Tc*)0, /* MARGModule__CInt.presentCount - YJQu__Ye9f */
 (Tc*)0, /* MARGModule__CInt.present - YJQu__Y8Dq */
 (Tc*)offsetof(YJQu, Vcurrent), /* Vcurrent */
 (Tc*)offsetof(YJQu, Vdefault), /* Vdefault */
 (Tc*)offsetof(YJQu, VtheValueList), /* VtheValueList */
 (Tc*)Y49ga, /* MARGModule__CInt.setToDefault - Y49ga */
...
To ToYJQu[] = {
 {6, 0},
 {offsetof(YJQu, VtheValueList), (Tt*)&list__T}, /* theValueList */
 {offsetof(YJQu, VshortName), (Tt*)&string__T}, /* shortName */
 {offsetof(YJQu, VlongName), (Tt*)&string__T}, /* longName */
 {offsetof(YJQu, Vdoc), (Tt*)&string__T}, /* doc */
 {offsetof(YJQu, VargName), (Tt*)&string__T}, /* argName */
 {offsetof(YJQu, Vpos), (Tt*)&YkxB__T}, /* pos */
};
Tto YJQu__T = {390, (Tc*)&YzBa, 0, ToYJQu};
YzqH *YBtk(YzqH *t, Tc *AshortName, Tc *AlongName, Tc *Adefault, Tc *Adoc) { /* MARGModule__CString.NEW */
 Zsf sf={0,topFrame};
 topFrame = &sf;
 if (t == NULL) {sf.pos=8063600; t = Zamt(sizeof(YzqH), YzqH__mt);}
 sf.pos=8063601;
...
YzqH *YzqH__YcLu(YzqH *t, Tc *AshortName, Tc *AlongName, Tc *Adoc, YkxB *Apos) { /* MARGModule__CString.NEW__p1 */
 Zsf sf={0,topFrame};
 topFrame = &sf;
 if (t == NULL) {sf.pos=483900; t = Zamt(sizeof(YzqH), YzqH__mt);}
 sf.pos=483901;
 if ((Y6fX != NULL))
 {
  Ytlm *ex;
 ...
 if (((AlongName != NULL) && (ZbyteStringSize(AlongName) != 0)))
 {
  ...
  {
   sf.pos=483915;
   YzqH__YofP(t, AlongName, ((YuQR *)ZDictGetPtr(YBQy, (Tz)(void*)AlongName)), Apos);
  }
  sf.pos=483916;
  ZDictAdd(0, YBQy, (Tz)(void*)AlongName, (Tz)(void*)(YuQR*)t);
 }
 ...
 if (((AshortName != NULL) && (ZbyteStringSize(AshortName) != 0)))
 {
  ...
  {
   sf.pos=483921;
   YzqH__YofP(t, AshortName, ((YuQR *)ZDictGetPtr(Y7be, (Tz)(void*)AshortName)), Apos);
  }
  sf.pos=483922;
  ZDictAdd(0, Y7be, (Tz)(void*)AshortName, (Tz)(void*)(YuQR*)t);
 }
...
void YzqH__YofP(YzqH *t, Tc *Aname, YuQR *Aflag, YkxB *Apos) { /* MARGModule__CString.throwDuplicate__p1 */
 ...
 sf.pos=5264801;
 VonePos = ((p3 = ((YVCw = (*(YkxB**)((Tc*)Aflag + (size_t)Aflag->mt[10])), YVCw == NULL ? NULL : YpI_((YkxB *)YVCw)))) == NULL ? (((Tc*)&YbbH)) : p3);
 sf.pos=5264802;
 Ve = YVNj__YwtA__YRHRa(NULL, Apos, ZcS5(((Tc*)&YtzG), Aname, ((Tc*)&YDyy), VonePos, (Tc*)1));
 sf.pos=5264803;
 ex = (Ytlm*)Ve;
...
Tc *YzqH__mt[] = {
 (Tc*)&YzqH__T,
 (Tc*)3,
 (Tc*)offsetof(YzqH, VshortName), /* VshortName */
 (Tc*)offsetof(YzqH, VlongName), /* VlongName */
 (Tc*)offsetof(YzqH, Vdoc), /* Vdoc */
 (Tc*)offsetof(YzqH, VargName), /* VargName */
 (Tc*)offsetof(YzqH, VsetCount), /* VsetCount */
 (Tc*)offsetof(YzqH, VcanRepeat), /* VcanRepeat */
 (Tc*)offsetof(YzqH, VnoCompactVal), /* VnoCompactVal */
 (Tc*)offsetof(YzqH, VargOpt), /* VargOpt */
 (Tc*)offsetof(YzqH, Vpos), /* Vpos */
 ...
 (Tc*)0, /* MARGModule__CString.presentCount - YzqH__Ye9f */
 (Tc*)YzqH__Y8Dq, /* MARGModule__CString.present - YzqH__Y8Dq */
 (Tc*)offsetof(YzqH, Vcurrent), /* Vcurrent */
 (Tc*)offsetof(YzqH, Vdefault), /* Vdefault */
 (Tc*)offsetof(YzqH, VtheValueList), /* VtheValueList */
 (Tc*)YJaza, /* MARGModule__CString.setToDefault - YJaza */
 (Tc*)0, /* MARGModule__CString.enableRepeat - YS6K */
 (Tc*)YPoi, /* MARGModule__CString.get - YPoi */
 (Tc*)YMjs, /* MARGModule__CString.value - YMjs */
...
To ToYzqH[] = {
 {8, 0},
 {offsetof(YzqH, Vcurrent), (Tt*)&string__T}, /* current */
 {offsetof(YzqH, Vdefault), (Tt*)&string__T}, /* default */
 {offsetof(YzqH, VtheValueList), (Tt*)&list__T}, /* theValueList */
 {offsetof(YzqH, VshortName), (Tt*)&string__T}, /* shortName */
 {offsetof(YzqH, VlongName), (Tt*)&string__T}, /* longName */
 {offsetof(YzqH, Vdoc), (Tt*)&string__T}, /* doc */
 {offsetof(YzqH, VargName), (Tt*)&string__T}, /* argName */
 {offsetof(YzqH, Vpos), (Tt*)&YkxB__T}, /* pos */
};
Tto YzqH__T = {390, (Tc*)&YDAE, 0, ToYzqH};
Y_SI *YSFa(Y_SI *t, Tc *AshortName, Tc *AlongName, Tl *Adefault, Tc *Adoc) { /* MARGModule__CStringList.NEW */
 Zsf sf={0,topFrame};
 topFrame = &sf;
 if (t == NULL) {sf.pos=6297200; t = Zamt(sizeof(Y_SI), Y_SI__mt);}
 sf.pos=6297201;
...
Y_SI *Y_SI__YcLu(Y_SI *t, Tc *AshortName, Tc *AlongName, Tc *Adoc, YkxB *Apos) { /* MARGModule__CStringList.NEW__p1 */
 Zsf sf={0,topFrame};
 topFrame = &sf;
 if (t == NULL) {sf.pos=3811900; t = Zamt(sizeof(Y_SI), Y_SI__mt);}
 sf.pos=3811901;
 if ((Y6fX != NULL))
 {
  Ytlm *ex;
 ...
 if (((AlongName != NULL) && (ZbyteStringSize(AlongName) != 0)))
 {
  ...
  {
   sf.pos=3811915;
   Y_SI__YofP(t, AlongName, ((YuQR *)ZDictGetPtr(YBQy, (Tz)(void*)AlongName)), Apos);
  }
  sf.pos=3811916;
  ZDictAdd(0, YBQy, (Tz)(void*)AlongName, (Tz)(void*)(YuQR*)t);
 }
 ...
 if (((AshortName != NULL) && (ZbyteStringSize(AshortName) != 0)))
 {
  ...
  {
   sf.pos=3811921;
   Y_SI__YofP(t, AshortName, ((YuQR *)ZDictGetPtr(Y7be, (Tz)(void*)AshortName)), Apos);
  }
  sf.pos=3811922;
  ZDictAdd(0, Y7be, (Tz)(void*)AshortName, (Tz)(void*)(YuQR*)t);
 }
...
void Y_SI__YofP(Y_SI *t, Tc *Aname, YuQR *Aflag, YkxB *Apos) { /* MARGModule__CStringList.throwDuplicate__p1 */
 ...
 sf.pos=4100001;
 VonePos = ((p4 = ((YZL6 = (*(YkxB**)((Tc*)Aflag + (size_t)Aflag->mt[10])), YZL6 == NULL ? NULL : YpI_((YkxB *)YZL6)))) == NULL ? (((Tc*)&YbbH)) : p4);
 sf.pos=4100002;
 Ve = YVNj__YwtA__YRHRa(NULL, Apos, ZcS5(((Tc*)&YtzG), Aname, ((Tc*)&YDyy), VonePos, (Tc*)1));
 sf.pos=4100003;
 ex = (Ytlm*)Ve;
...
Tc *Y_SI__mt[] = {
 (Tc*)&Y_SI__T,
 (Tc*)4,
 (Tc*)offsetof(Y_SI, VshortName), /* VshortName */
 (Tc*)offsetof(Y_SI, VlongName), /* VlongName */
 (Tc*)offsetof(Y_SI, Vdoc), /* Vdoc */
 (Tc*)offsetof(Y_SI, VargName), /* VargName */
 (Tc*)offsetof(Y_SI, VsetCount), /* VsetCount */
 (Tc*)offsetof(Y_SI, VcanRepeat), /* VcanRepeat */
 (Tc*)offsetof(Y_SI, VnoCompactVal), /* VnoCompactVal */
 (Tc*)offsetof(Y_SI, VargOpt), /* VargOpt */
 (Tc*)offsetof(Y_SI, Vpos), /* Vpos */
 ...
 (Tc*)0, /* MARGModule__CStringList.presentCount - Y_SI__Ye9f */
 (Tc*)Y_SI__Y8Dq, /* MARGModule__CStringList.present - Y_SI__Y8Dq */
 (Tc*)offsetof(Y_SI, Vcurrent), /* Vcurrent */
 (Tc*)offsetof(Y_SI, Vdefault), /* Vdefault */
 (Tc*)YSkKa, /* MARGModule__CStringList.setToDefault - YSkKa */
 (Tc*)YEKc, /* MARGModule__CStringList.get - YEKc */
 (Tc*)0, /* MARGModule__CStringList.value - YSNX */
 (Tc*)0, /* Init - Y_SIa */
};
To ToY_SI[] = {
 {7, 0},
 {offsetof(Y_SI, Vcurrent), (Tt*)&list__T}, /* current */
 {offsetof(Y_SI, Vdefault), (Tt*)&list__T}, /* default */
 {offsetof(Y_SI, VshortName), (Tt*)&string__T}, /* shortName */
 {offsetof(Y_SI, VlongName), (Tt*)&string__T}, /* longName */
 {offsetof(Y_SI, Vdoc), (Tt*)&string__T}, /* doc */
 {offsetof(Y_SI, VargName), (Tt*)&string__T}, /* argName */
 {offsetof(Y_SI, Vpos), (Tt*)&YkxB__T}, /* pos */
};
...
/* ARGModule done */
/* including Arguments bodies */
/* including CommonFlags bodies */
...
Yd7N *Yd7N__YwtA__YRHR(Yd7N *t, Tc *Amsg) { /* MProto__CE_ParseError.NEW__p2 */
 Zsf sf={0,topFrame};
 topFrame = &sf;
 if (t == NULL) {sf.pos=3918600; t = Zamt(sizeof(Yd7N), Yd7N__mt);}
 sf.pos=3918601;
 t->Vmessage = Amsg;
 sf.pos=3918602;
 t->Vpos = MZ__callerPos();
...
Tc *Yd7N__mt[] = {
 (Tc*)&Yd7N__T,
 (Tc*)28,
 (Tc*)offsetof(Yd7N, Vmessage), /* Vmessage */
 (Tc*)offsetof(Yd7N, Vpos), /* Vpos */
 (Tc*)offsetof(Yd7N, Vbacktrace), /* Vbacktrace */
 (Tc*)0, /* MProto__CE_ParseError.ToString - YH0V */
 (Tc*)YxaJa, /* MProto__CE_ParseError.writeTo - YxaJa */
 (Tc*)YxaJ, /* MProto__CE_ParseError.writeTo - YxaJ */
 (Tc*)0, /* MProto__CE_ParseError.toString - Yoww */
 (Tc*)0, /* MProto__CE_ParseError.getMessage - YCzX */
 (Tc*)0, /* MProto__CE_ParseError.getPos - YvCK */
 (Tc*)0, /* MProto__CE_ParseError.getBacktrace - Y4bq */
 (Tc*)0, /* Init - Yd7Na */
 (Tc*)0, /* MProto__CE_ParseError.ToString - YH0V */
 (Tc*)0, /* MProto__CE_ParseError.toString - Yoww */
 (Tc*)0, /* MProto__CE_ParseError.getMessage - YCzX */
...
To ToYd7N[] = {
 {3, 0},
 {offsetof(Yd7N, Vmessage), (Tt*)&string__T}, /* message */
 {offsetof(Yd7N, Vpos), (Tt*)&YkxB__T}, /* pos */
 {offsetof(Yd7N, Vbacktrace), (Tt*)&list__T}, /* backtrace */
};
...
To ToYqvM[] = {
 {1, 0},
 {offsetof(YqvM, Vname), (Tt*)&string__T}, /* name */
};
...
YBRp *YtIRa(YBRp *t, Tr Areader, Tb AwithRefs) { /* MProto__CReader.NEW */
 ...
 {
  sf.pos=2771003;
  t->Vrefs = ZnewDict((Tt*)&int__T, (Tt*)&xobj__T, 0);
 }
 topFrame = sf.prev;
 return t;
}
...
To ToYBRp[] = {
 {2, 0},
 {offsetof(YBRp, VtheCharReader), (Tt*)&YrC3__T}, /* theCharReader */
 {offsetof(YBRp, Vrefs), (Tt*)&dict__T}, /* refs */
};
...
YWuL:
  ...
  else
  {
   ...
   if ((Vc != 32))
   {
    Ytlm *ex;
    sf.pos=1287524;
    ex = (Ytlm*)Yd7N__YwtA__YRHR(NULL, ZcS3(((Tc*)&Y3CY), Zint2string(Vreader->Vlnum), ((Tc*)&YKvI)));
    ZthrowIobject(ex);
   }
   sf.pos=1287525;
   Vname = YbNW((YjUM *)Vw);
   ...
   VuseNr = 0;
   sf.pos=1287526;
   if (isdigit(ZstringGetChar(Vname, 0)))
   {
    sf.pos=1287527;
    VuseNr = 1;
    sf.pos=1287528;
    Vnr = ZstringToInt(Vname, 1, 0);
   }
   Vfound = 0;
   sf.pos=1287529;
   {
    Tfl Zf3i;
    Zf3 = ((Tl* (*)(void*))(Amsg->mt[47]))(Amsg);
    Zf3i.l = Zf3;
    Zf3i.valp = (void*)&Vfspec;
    Zf3i.i = 0;
    for (; ZforListPtrCont(&Zf3i); ) {
    sf.pos=1287530;
    if (((VuseNr) ? ((Vfspec->Vnr == Vnr)) : ((ZstringCmp(Vfspec->Vname, Vname) == 0))))
    {
     sf.pos=1287531;
     Vfound = 1;
     sf.pos=1287532;
     if ((VmissingColon && (Vfspec->Vtype != 12)))
     {
      Ytlm *ex;
      sf.pos=1287533;
      ex = (Ytlm*)Yd7N__YwtA__YRHR(NULL, ZcS3(((Tc*)&Y3CY), Zint2string(Vreader->Vlnum), ((Tc*)&Ygmn)));
      ZthrowIobject(ex);
     }
     sf.pos=1287534;
     switch (Vfspec->Vtype)
...
YjQd:
       ...
       if ((Vc != 10))
       {
        Ytlm *ex;
        sf.pos=1287541;
        ex = (Ytlm*)Yd7N__YwtA__YRHR(NULL, ZcS3(((Tc*)&Y3CY), Zint2string(Vreader->Vlnum), ((Tc*)&YtkL)));
        ZthrowIobject(ex);
       }
       sf.pos=1287542;
       if ((Vfspec->Vtype == 10))
       {
        ...
        Vv32 = Vv;
        sf.pos=1287544;
        ((void (*)(void*, Ti, Ti32))(Amsg->mt[33]))(Amsg, Vfspec->Vnr, Vv32);
       }
       else {
       sf.pos=1287545;
       if ((Vfspec->Vtype == 19))
       {
        ...
        Vn64 = Vv;
        sf.pos=1287547;
        ((void (*)(void*, Ti, Tu))(Amsg->mt[34]))(Amsg, Vfspec->Vnr, Vn64);
       }
       else {
       sf.pos=1287548;
       if ((Vfspec->Vtype == 18))
       {
        ...
        Vn32 = Vv;
        sf.pos=1287550;
        ((void (*)(void*, Ti, Tu32))(Amsg->mt[35]))(Amsg, Vfspec->Vnr, Vn32);
       }
       else
       {
        sf.pos=1287551;
        ((void (*)(void*, Ti, Ti))(Amsg->mt[32]))(Amsg, Vfspec->Vnr, Vv);
       }
       }}
        break;
      }
      case 6:
      {
       ...
       Vf = YRvX(Vreader);
       sf.pos=1287553;
       ((void (*)(void*, Ti, Tf32))(Amsg->mt[36]))(Amsg, Vfspec->Vnr, Vf);
        break;
      }
      case 7:
      {
       ...
       Vf = YRvX(Vreader);
       sf.pos=1287555;
       ((void (*)(void*, Ti, Tf))(Amsg->mt[37]))(Amsg, Vfspec->Vnr, Vf);
        break;
      }
      case 1:
      {
       ...
       sf.pos=1287561;
       {
        ...
        if ((Vc != Vnc))
        {
         Ytlm *ex;
         sf.pos=1287563;
         ex = (Ytlm*)Yd7N__YwtA__YRHR(NULL, ZcS3(((Tc*)&Y3CY), Zint2string(Vreader->Vlnum), ((Tc*)&Y6QC)));
         ZthrowIobject(ex);
        }
        sf.pos=1287564;
        Vc = Y0_W((YBRp *)Vreader);
       ...
       if ((Vc != 10))
       {
        Ytlm *ex;
        sf.pos=1287567;
        ex = (Ytlm*)Yd7N__YwtA__YRHR(NULL, ZcS3(((Tc*)&Y3CY), Zint2string(Vreader->Vlnum), ((Tc*)&YQJD)));
        ZthrowIobject(ex);
       }
       sf.pos=1287568;
       ((void (*)(void*, Ti, Tb))(Amsg->mt[38]))(Amsg, Vfspec->Vnr, Vv);
        break;
      }
      case 17:
      {
       sf.pos=1287569;
       Vsw = Zamt(sizeof(YjUM), YjUM__mt);
       sf.pos=1287570;
       Vc = Y0_W((YBRp *)Vreader);
       sf.pos=1287571;
       if ((Vc != 34))
       {
        Ytlm *ex;
        sf.pos=1287572;
        ex = (Ytlm*)Yd7N__YwtA__YRHR(NULL, ZcS3(((Tc*)&Y3CY), Zint2string(Vreader->Vlnum), ((Tc*)&YSfR)));
        ZthrowIobject(ex);
       }
       sf.pos=1287573;
       while (1)
...
YRi8:
       ...
       if ((Vc != 34))
       {
        Ytlm *ex;
        sf.pos=1287579;
        ex = (Ytlm*)Yd7N__YwtA__YRHR(NULL, ZcS3(((Tc*)&Y3CY), Zint2string(Vreader->Vlnum), ((Tc*)&Y7ax)));
        ZthrowIobject(ex);
       }
       sf.pos=1287580;
       Vc = Y0_W((YBRp *)Vreader);
       ...
       if ((Vc != 10))
       {
        Ytlm *ex;
        sf.pos=1287582;
        ex = (Ytlm*)Yd7N__YwtA__YRHR(NULL, ZcS3(((Tc*)&Y3CY), Zint2string(Vreader->Vlnum), ((Tc*)&Yc56)));
        ZthrowIobject(ex);
       }
       sf.pos=1287583;
       ((void (*)(void*, Ti, Tc*))(Amsg->mt[39]))(Amsg, Vfspec->Vnr, YbNW((YjUM *)Vsw));
        break;
      }
      case 2:
      {
       sf.pos=1287584;
       Vbw = Zamt(sizeof(Yjcw), Yjcw__mt);
       sf.pos=1287585;
       Vc = Y0_W((YBRp *)Vreader);
       sf.pos=1287586;
       if ((Vc != 34))
...
YeKG:
       ...
       sf.pos=1287598;
       ((void (*)(void*, Ti, Tc*))(Amsg->mt[40]))(Amsg, Vfspec->Vnr, Y8Km((Yjcw *)Vbw));
        break;
      }
      case 3:
      {
       sf.pos=1287599;
       Vsw1 = Zamt(sizeof(YjUM), YjUM__mt);
       sf.pos=1287600;
       while (1)
       {
        sf.pos=1287601;
...
Yn7s:
       ...
       if ((Vc != 10))
       {
        Ytlm *ex;
        sf.pos=1287606;
        ex = (Ytlm*)Yd7N__YwtA__YRHR(NULL, ZcS3(((Tc*)&Y3CY), Zint2string(Vreader->Vlnum), ((Tc*)&Ynwt)));
        ZthrowIobject(ex);
       }
       sf.pos=1287607;
       VenumName = YbNW((YjUM *)Vsw1);
       sf.pos=1287608;
       if (isdigit(ZstringGetChar(VenumName, 0)))
       {
        sf.pos=1287609;
        ((void (*)(void*, Ti, Ti))(Amsg->mt[30]))(Amsg, Vfspec->Vnr, ZstringToInt(VenumName, 1, 0));
       }
       else
       {
        sf.pos=1287610;
        ((void (*)(void*, Ti, Tc*))(Amsg->mt[31]))(Amsg, Vfspec->Vnr, VenumName);
       }
        break;
      }
      case 12:
      {
       ...
       if ((Vc != 123))
       {
        Ytlm *ex;
        sf.pos=1287613;
        ex = (Ytlm*)Yd7N__YwtA__YRHR(NULL, ZcS3(((Tc*)&Y3CY), Zint2string(Vreader->Vlnum), ((Tc*)&Ye6A)));
        ZthrowIobject(ex);
       }
       sf.pos=1287614;
       Vc = Y0_W((YBRp *)Vreader);
       ...
       if ((Vc != 10))
       {
        Ytlm *ex;
        sf.pos=1287616;
        ex = (Ytlm*)Yd7N__YwtA__YRHR(NULL, ZcS3(((Tc*)&Y3CY), Zint2string(Vreader->Vlnum), ((Tc*)&YNnz)));
        ZthrowIobject(ex);
       }
       sf.pos=1287617;
       ...
       if ((Vc != 125))
       {
        Ytlm *ex;
        sf.pos=1287620;
        ex = (Ytlm*)Yd7N__YwtA__YRHR(NULL, ZcS3(((Tc*)&Y3CY), Zint2string(Vreader->Vlnum), ((Tc*)&YQUJ)));
        ZthrowIobject(ex);
       }
       sf.pos=1287621;
       Vc = Y0_W((YBRp *)Vreader);
       ...
       if ((Vc != 10))
       {
        Ytlm *ex;
        sf.pos=1287623;
        ex = (Ytlm*)Yd7N__YwtA__YRHR(NULL, ZcS3(((Tc*)&Y3CY), Zint2string(Vreader->Vlnum), ((Tc*)&YPnz)));
        ZthrowIobject(ex);
       }
        break;
      }
     default:
      {
       Ytlm *ex;
       sf.pos=1287624;
       ex = (Ytlm*)Yd7N__YwtA__YRHR(NULL, ZcS5(((Tc*)&Y3CY), Zint2string(Vreader->Vlnum), ((Tc*)&YIQN), (t0 = Zenum2string(MProto__EType, Vfspec->Vtype)), (Tc*)1));
       ZthrowIobject(ex);
      }
     }
     rt = 2;
...
YjFx:
 ...
 if ((Vc != 10))
 {
  Ytlm *ex;
  sf.pos=4237807;
  ex = (Ytlm*)Yd7N__YwtA__YRHR(NULL, ZcS3(((Tc*)&Y3CY), Zint2string(Areader->Vlnum), ((Tc*)&YtkL)));
  ZthrowIobject(ex);
 }
 sf.pos=4237808;
 r = Zstring2float(YbNW((YjUM *)Vw), 0);
 topFrame = sf.prev;
 return r;
}
Tb YPR3(YFL0 *A0, Ti A1, Te A2, Tr A3) {
   return YNdL__Ymza((void*)A0,A1,A2,A3);
}
/* Proto done */
YNdL *YA_Z(YNdL *t) { /* MZimbu__CConfig.NEW */
 Zsf sf={0,topFrame};
...
YNdL *YtKN(Tr Areader) { /* MZimbu__CConfig__X.createFromText */
 ...
 topFrame = &sf;
 sf.pos=8300700;
 r = YUx0((YNdL *)YA_Z(NULL), *Znao(&t0, YtIRa(NULL, Areader, 0), YBRp__YMd3_imt, 0));
 topFrame = sf.prev;
 return r;
}
void YNdL__Y3p7(YNdL *t, Ti AfieldNr, Ti Avalue) { /* MZimbu__CConfig.enumSet__p1 */
...
Tc *YNdL__mt[] = {
 ...
 (Tc*)0, /* MZimbu__CConfig.bytesGet - YNdL__YlHQa */
 (Tc*)0, /* MZimbu__CConfig.bytesGet - YNdL__YlHQ */
 (Tc*)YNdL__Y3p7, /* MZimbu__CConfig.enumSet - YNdL__Y3p7 */
 ...
 (Tc*)YNdL__Yoxk, /* MZimbu__CConfig.bytesSet - YNdL__Yoxk */
 ...
 (Tc*)0, /* MZimbu__CConfig.writeJson - YNdL__YVaR */
 (Tc*)0, /* MZimbu__CConfig.writeJsonDeref - YNdL__YgZk */
 (Tc*)offsetof(YNdL, Vf_mallocArg), /* Vf_mallocArg */
 (Tc*)0, /* MZimbu__CConfig.setMallocArg - YrF2 */
 (Tc*)Y5PP, /* MZimbu__CConfig.getMallocArg - Y5PP */
 (Tc*)0, /* MZimbu__CConfig.hasMallocArg - Y8zW */
 (Tc*)0, /* MZimbu__CConfig.clearMallocArg - YM3c */
 (Tc*)offsetof(YNdL, Vf_threadArg), /* Vf_threadArg */
 (Tc*)0, /* MZimbu__CConfig.setThreadArg - YOPG */
 (Tc*)Ys_s, /* MZimbu__CConfig.getThreadArg - Ys_s */
 (Tc*)0, /* MZimbu__CConfig.hasThreadArg - YvKz */
 (Tc*)0, /* MZimbu__CConfig.clearThreadArg - YpUz */
 (Tc*)offsetof(YNdL, Vf_socketArg), /* Vf_socketArg */
 (Tc*)0, /* MZimbu__CConfig.setSocketArg - YWoP */
 (Tc*)YAzB, /* MZimbu__CConfig.getSocketArg - YAzB */
 (Tc*)0, /* MZimbu__CConfig.hasSocketArg - YDjI */
 (Tc*)0, /* MZimbu__CConfig.clearSocketArg - Yhkr */
 (Tc*)offsetof(YNdL, Vf_mathArg), /* Vf_mathArg */
 (Tc*)0, /* MZimbu__CConfig.setMathArg - Yjrt */
 (Tc*)YQ_S, /* MZimbu__CConfig.getMathArg - YQ_S */
 (Tc*)0, /* MZimbu__CConfig.hasMathArg - Y8om */
 (Tc*)0, /* MZimbu__CConfig.clearMathArg - Yfqy */
 (Tc*)offsetof(YNdL, Vf_pcreArg), /* Vf_pcreArg */
 (Tc*)0, /* MZimbu__CConfig.setPcreArg - YMyf */
 (Tc*)YnT5, /* MZimbu__CConfig.getPcreArg - YnT5 */
 (Tc*)0, /* MZimbu__CConfig.hasPcreArg - YGhA */
 (Tc*)0, /* MZimbu__CConfig.clearPcreArg - YNiM */
 (Tc*)offsetof(YNdL, Vf_haveResolve), /* Vf_haveResolve */
 (Tc*)0, /* MZimbu__CConfig.setHaveResolve - Yqt5 */
 (Tc*)YqzX, /* MZimbu__CConfig.getHaveResolve - YqzX */
 (Tc*)0, /* MZimbu__CConfig.hasHaveResolve - Y3Lr */
 (Tc*)0, /* MZimbu__CConfig.clearHaveResolve - Y9nB */
 (Tc*)offsetof(YNdL, Vf_haveFork), /* Vf_haveFork */
 (Tc*)0, /* MZimbu__CConfig.setHaveFork - YBhB */
 (Tc*)Y7ik, /* MZimbu__CConfig.getHaveFork - Y7ik */
 (Tc*)0, /* MZimbu__CConfig.hasHaveFork - YcPw */
 (Tc*)0, /* MZimbu__CConfig.clearHaveFork - YdMB */
 (Tc*)offsetof(YNdL, Vf_exeSuffix), /* Vf_exeSuffix */
 (Tc*)0, /* MZimbu__CConfig.setExeSuffix - YNXX */
 (Tc*)Yr7J, /* MZimbu__CConfig.getExeSuffix - Yr7J */
 (Tc*)0, /* MZimbu__CConfig.hasExeSuffix - YuSQ */
 (Tc*)0, /* MZimbu__CConfig.clearExeSuffix - YqMi */
 (Tc*)offsetof(YNdL, Vf_exePrefix), /* Vf_exePrefix */
 (Tc*)0, /* MZimbu__CConfig.setExePrefix - YcU3 */
 (Tc*)YR3Q, /* MZimbu__CConfig.getExePrefix - YR3Q */
 (Tc*)0, /* MZimbu__CConfig.hasExePrefix - YUOX */
 (Tc*)0, /* MZimbu__CConfig.clearExePrefix - Y0Pb */
 (Tc*)offsetof(YNdL, Vf_haveSigaction), /* Vf_haveSigaction */
 (Tc*)0, /* MZimbu__CConfig.setHaveSigaction - Y118 */
 (Tc*)YZQV, /* MZimbu__CConfig.getHaveSigaction - YZQV */
 (Tc*)0, /* MZimbu__CConfig.hasHaveSigaction - YJrk */
 (Tc*)0, /* MZimbu__CConfig.clearHaveSigaction - YiKD */
 (Tc*)offsetof(YNdL, Vf_gcWithThreads), /* Vf_gcWithThreads */
 (Tc*)0, /* MZimbu__CConfig.setGcWithThreads - YEDn */
 (Tc*)Yjd9, /* MZimbu__CConfig.getGcWithThreads - Yjd9 */
 (Tc*)0, /* MZimbu__CConfig.hasGcWithThreads - Yo45 */
 (Tc*)0, /* MZimbu__CConfig.clearGcWithThreads - YYmp */
 (Tc*)offsetof(YNdL, Vf_int16Name), /* Vf_int16Name */
 (Tc*)0, /* MZimbu__CConfig.setInt16Name - YIIX */
 (Tc*)YmTJ, /* MZimbu__CConfig.getInt16Name - YmTJ */
 (Tc*)0, /* MZimbu__CConfig.hasInt16Name - YpDQ */
 (Tc*)0, /* MZimbu__CConfig.clearInt16Name - Yv0i */
 (Tc*)offsetof(YNdL, Vf_int32Name), /* Vf_int32Name */
 (Tc*)0, /* MZimbu__CConfig.setInt32Name - Y8TB */
 (Tc*)YN3n, /* MZimbu__CConfig.getInt32Name - YN3n */
 (Tc*)0, /* MZimbu__CConfig.hasInt32Name - YQOu */
 (Tc*)0, /* MZimbu__CConfig.clearInt32Name - Y4PE */
 (Tc*)offsetof(YNdL, Vf_int64Name), /* Vf_int64Name */
 (Tc*)0, /* MZimbu__CConfig.setInt64Name - Y6PM */
 (Tc*)YL_y, /* MZimbu__CConfig.getInt64Name - YL_y */
 (Tc*)0, /* MZimbu__CConfig.hasInt64Name - YOKF */
 (Tc*)0, /* MZimbu__CConfig.clearInt64Name - Y6Tt */
 (Tc*)offsetof(YNdL, Vf_nat16Name), /* Vf_nat16Name */
 (Tc*)0, /* MZimbu__CConfig.setNat16Name - YXzR */
 (Tc*)YBKD, /* MZimbu__CConfig.getNat16Name - YBKD */
 (Tc*)0, /* MZimbu__CConfig.hasNat16Name - YEuK */
 (Tc*)0, /* MZimbu__CConfig.clearNat16Name - Yg9o */
 (Tc*)offsetof(YNdL, Vf_nat32Name), /* Vf_nat32Name */
 (Tc*)0, /* MZimbu__CConfig.setNat32Name - YnLv */
 (Tc*)Y1Vh, /* MZimbu__CConfig.getNat32Name - Y1Vh */
 (Tc*)0, /* MZimbu__CConfig.hasNat32Name - Y4Fo */
 (Tc*)0, /* MZimbu__CConfig.clearNat32Name - YQYKa */
 (Tc*)offsetof(YNdL, Vf_nat64Name), /* Vf_nat64Name */
 (Tc*)0, /* MZimbu__CConfig.setNat64Name - YlHG */
 (Tc*)Y_Rs, /* MZimbu__CConfig.getNat64Name - Y_Rs */
 (Tc*)0, /* MZimbu__CConfig.hasNat64Name - Y2Bz */
 (Tc*)0, /* MZimbu__CConfig.clearNat64Name - YS1z */
 (Tc*)offsetof(YNdL, Vf_floatName), /* Vf_floatName */
 (Tc*)0, /* MZimbu__CConfig.setFloatName - Yla2 */
 (Tc*)Y_kP, /* MZimbu__CConfig.getFloatName - Y_kP */
 (Tc*)0, /* MZimbu__CConfig.hasFloatName - Y24V */
 (Tc*)0, /* MZimbu__CConfig.clearFloatName - YSyd */
 (Tc*)offsetof(YNdL, Vf_float32Name), /* Vf_float32Name */
 (Tc*)0, /* MZimbu__CConfig.setFloat32Name - YI4N */
 (Tc*)YTF6, /* MZimbu__CConfig.getFloat32Name - YTF6 */
 (Tc*)0, /* MZimbu__CConfig.hasFloat32Name - YftC */
 (Tc*)0, /* MZimbu__CConfig.clearFloat32Name - Ytwp */
 (Tc*)offsetof(YNdL, Vf_intPtrName), /* Vf_intPtrName */
 (Tc*)0, /* MZimbu__CConfig.setIntPtrName - YJ6V */
 (Tc*)Ymy9, /* MZimbu__CConfig.getIntPtrName - Ymy9 */
 (Tc*)0, /* MZimbu__CConfig.hasIntPtrName - YTxb */
 (Tc*)0, /* MZimbu__CConfig.clearIntPtrName - YaFB */
 (Tc*)offsetof(YNdL, Vf_printIntFormat), /* Vf_printIntFormat */
 (Tc*)0, /* MZimbu__CConfig.setPrintIntFormat - YUld */
 (Tc*)YoDj, /* MZimbu__CConfig.getPrintIntFormat - YoDj */
 (Tc*)0, /* MZimbu__CConfig.hasPrintIntFormat - YlFq */
 (Tc*)0, /* MZimbu__CConfig.clearPrintIntFormat - YgH3 */
 (Tc*)offsetof(YNdL, Vf_printNatFormat), /* Vf_printNatFormat */
 (Tc*)0, /* MZimbu__CConfig.setPrintNatFormat - Y8c7 */
 (Tc*)YDud, /* MZimbu__CConfig.getPrintNatFormat - YDud */
 (Tc*)0, /* MZimbu__CConfig.hasPrintNatFormat - Y6Nw */
 (Tc*)0, /* MZimbu__CConfig.clearPrintNatFormat - YvyY */
 (Tc*)offsetof(YNdL, Vf_scanfHexFormat), /* Vf_scanfHexFormat */
 (Tc*)0, /* MZimbu__CConfig.setScanfHexFormat - YRMv */
 (Tc*)Y_eH, /* MZimbu__CConfig.getScanfHexFormat - Y_eH */
 (Tc*)0, /* MZimbu__CConfig.hasScanfHexFormat - Yoe8 */
 (Tc*)0, /* MZimbu__CConfig.clearScanfHexFormat - Yd7l */
 (Tc*)offsetof(YNdL, Vf_isMingw), /* Vf_isMingw */
 (Tc*)0, /* MZimbu__CConfig.setIsMingw - YeB5 */
 (Tc*)YVQf, /* MZimbu__CConfig.getIsMingw - YVQf */
 (Tc*)0, /* MZimbu__CConfig.hasIsMingw - YdfK */
 ...
 (Tc*)YUx0, /* MZimbu__CConfig.mergeFromText - YUx0 */
...
To ToYNdL[] = {
 {19, 0},
 {offsetof(YNdL, Vf_mallocArg), (Tt*)&string__T}, /* f_mallocArg */
 {offsetof(YNdL, Vf_threadArg), (Tt*)&string__T}, /* f_threadArg */
 {offsetof(YNdL, Vf_socketArg), (Tt*)&string__T}, /* f_socketArg */
 {offsetof(YNdL, Vf_mathArg), (Tt*)&string__T}, /* f_mathArg */
 {offsetof(YNdL, Vf_pcreArg), (Tt*)&string__T}, /* f_pcreArg */
 {offsetof(YNdL, Vf_exeSuffix), (Tt*)&string__T}, /* f_exeSuffix */
 {offsetof(YNdL, Vf_exePrefix), (Tt*)&string__T}, /* f_exePrefix */
 {offsetof(YNdL, Vf_int16Name), (Tt*)&string__T}, /* f_int16Name */
 {offsetof(YNdL, Vf_int32Name), (Tt*)&string__T}, /* f_int32Name */
 {offsetof(YNdL, Vf_int64Name), (Tt*)&string__T}, /* f_int64Name */
 {offsetof(YNdL, Vf_nat16Name), (Tt*)&string__T}, /* f_nat16Name */
 {offsetof(YNdL, Vf_nat32Name), (Tt*)&string__T}, /* f_nat32Name */
 {offsetof(YNdL, Vf_nat64Name), (Tt*)&string__T}, /* f_nat64Name */
 {offsetof(YNdL, Vf_floatName), (Tt*)&string__T}, /* f_floatName */
 {offsetof(YNdL, Vf_float32Name), (Tt*)&string__T}, /* f_float32Name */
 {offsetof(YNdL, Vf_intPtrName), (Tt*)&string__T}, /* f_intPtrName */
 {offsetof(YNdL, Vf_printIntFormat), (Tt*)&string__T}, /* f_printIntFormat */
 {offsetof(YNdL, Vf_printNatFormat), (Tt*)&string__T}, /* f_printNatFormat */
 {offsetof(YNdL, Vf_scanfHexFormat), (Tt*)&string__T}, /* f_scanfHexFormat */
};
...
Ts YszV() { /* MConfig.run */
 ...
 else
 {
  ...
  if (ZstringStartsWith(Vroot, Vcurdir, 0))
  {
   ...
   {
    sf.pos=2347813;
    Vroot = YuAL(Vroot, (ZstringSize(Vcurdir) + 1));
   }
   else
   {
    sf.pos=2347814;
    Vroot = YuAL(Vroot, ZstringSize(Vcurdir));
   }
  }
 }
 sf.pos=2347815;
 ...
 sf.pos=2347823;
 Y9bJ = YtKN(ZconvertZiopref(Vreader, YFWV__imtt, -3, 99998, 2347824));
 sf.pos=2347825;
 YrF8((Yw8L *)Vreader);
 sf.pos=2347826;
 YE4f = Y5PP((YNdL *)Y9bJ);
...
Tc *YEL8(Tc *AsrcName, Tc *AbinName, Tbs AtargetLang) { /* MConfig.compilerCmd */
 ...
 {
  sf.pos=5855601;
  r = ZcS12(YMjs((YzqH *)Y6Gp), ((Tc*)&YG), (t0 = YMjs((YzqH *)YJ5o)), ((Tc*)&Yb1k), AbinName, ((Tc*)&Yb1), ((Tc*)&YI), AsrcName, ((Tc*)&Yb1), (t2 = YMjs((YzqH *)Y6ma)), (Tc*)1, (Tc*)1);
  rt = 1;
  goto YETe;
 }
 sf.pos=5855602;
 ...
 {
  sf.pos=5855603;
  r = ZcS8((t5 = YMjs((YzqH *)Yvr6)), ((Tc*)&YG), YMjs((YzqH *)YKXV), ((Tc*)&Y3KT), (t0 = YTTE), ((Tc*)&Yjmy), (t2 = AsrcName), ((Tc*)&Yb1));
  rt = 1;
  goto YETe;
 }
 sf.pos=5855604;
...
Tc *YRe9(Tc *AbinName, Tl *AclassFiles) { /* MConfig.jarCmd */
 ...
 topFrame = &sf;
 sf.pos=5498600;
 Vzudir = Yq8a(YkNL(AbinName), Yfev);
 sf.pos=5498601;
 Vw = Zamt(sizeof(YjUM), YjUM__mt);
 sf.pos=5498602;
 {
  ...
  for (; ZforListPtrCont(&Zf1i); ) {
  sf.pos=5498603;
  if ((ZstringSize(YiNl) == 0))
  {
   sf.pos=5498604;
   YJqza((YjUM *)Vw, ZcS5(((Tc*)&YZAj), Vzudir, ((Tc*)&Yomy), (t0 = Vf), ((Tc*)&Yc9)));
  }
  else
  {
   sf.pos=5498605;
   YJqza((YjUM *)Vw, ZcS5(((Tc*)&YZAj), Vzudir, ((Tc*)&Yjmy), (t0 = Vf), ((Tc*)&Yb1)));
  }
  sf.pos=5498606;
  }
 }
 sf.pos=5498607;
 r = ZcS5((t3 = YMjs((YzqH *)YXJ1)), ((Tc*)&YQZ4), AbinName, ((Tc*)&Yj1q), (t0 = YbNW((YjUM *)Vw)));
 topFrame = sf.prev;
 return r;
}
int JConfig(int round) {
 ...
 if (round == 1) {
   ...
   sf.pos=2239802;
   YJa3 = YttT(NULL, NULL, ((Tc*)&YDq4), 0, ((Tc*)&Y2Hj));
   sf.pos=2239805;
   Y6Gp = ((YzqH *)Znip(&YzqH__T, 2239804, (YzqH__Y836((YzqH *)YBtk(NULL, NULL, ((Tc*)&YsHb), ((Tc*)&YsHb), ((Tc*)&YhxU)), ((Tc*)&YeLO)))));
   sf.pos=2239806;
   YJ5o = YBtk(NULL, NULL, ((Tc*)&YApf), ((Tc*)&YXja), ((Tc*)&Yl1G));
   sf.pos=2239807;
   Y6ma = YBtk(NULL, NULL, ((Tc*)&Yerz), ((Tc*)&Ya), ((Tc*)&YTzz));
   sf.pos=2239809;
   Yvr6 = ((YzqH *)Znip(&YzqH__T, 2239808, (YzqH__Y836((YzqH *)YBtk(NULL, NULL, ((Tc*)&YpP_), ((Tc*)&YpP_), ((Tc*)&YsyB)), ((Tc*)&Yh83)))));
   sf.pos=2239811;
   YKXV = ((YzqH *)Znip(&YzqH__T, 2239810, (YzqH__Y836((YzqH *)YBtk(NULL, NULL, ((Tc*)&Yx9s), ((Tc*)&YOGX), ((Tc*)&YaRa)), ((Tc*)&YAKe)))));
   sf.pos=2239812;
   YXJ1 = YBtk(NULL, NULL, ((Tc*)&Y44v), ((Tc*)&Y44v), ((Tc*)&YepT));
   sf.pos=2239813;
...
Tc *Yh9t() { /* MCommonFlags.getArguments */
 ...
 {
  sf.pos=8008309;
  Vcmd =  ZcS(Vcmd, ((Tc*)&YliG));
 }
 sf.pos=8008310;
 if (YHoR((Y86c *)Yji4))
 {
  sf.pos=8008311;
  Vcmd =  ZcS(Vcmd, ((Tc*)&Yrtq));
 }
 sf.pos=8008312;
 if (YHoR((Y86c *)Y5HV))
 {
 ...
 sf.pos=8008318;
 Vcmd =  ZcS(Vcmd, ZcS(((Tc*)&Ym79), YPoi((YzqH *)YpLr)));
 sf.pos=8008319;
 if (YHoR((Y86c *)YaSM))
 {
  sf.pos=8008320;
 ...
 {
  sf.pos=8008322;
  Vcmd =  ZcS(Vcmd, ((Tc*)&Yd8v));
 }
 sf.pos=8008323;
 Vcmd =  ZcS(Vcmd, ZcS3(((Tc*)&Y0Y), YHc7, ((Tc*)&YI)));
 sf.pos=8008324;
 r = Vcmd;
 topFrame = sf.prev;
 return r;
...
int JCommonFlags(int round) {
 ...
 if (round == 1) {
   sf.pos=1549800;
   YFnI = YttT(NULL, ((Tc*)&Y6a), ((Tc*)&YjUR), 1, ((Tc*)&YPXR));
   sf.pos=1549801;
   YX4y = YttT(NULL, NULL, ((Tc*)&YWSb), 0, ((Tc*)&Y7Ds));
   sf.pos=1549802;
   Yji4 = YttT(NULL, NULL, ((Tc*)&YvIV), 0, ((Tc*)&YtzM));
   sf.pos=1549803;
   Y5HV = YttT(NULL, NULL, ((Tc*)&Y5Ka), 0, ((Tc*)&YAP6));
   sf.pos=1549804;
   YaNI = YttT(NULL, NULL, ((Tc*)&YzNS), 0, ((Tc*)&Yb3W));
   sf.pos=1549805;
   YpLr = YBtk(NULL, NULL, ((Tc*)&YBMJ), ((Tc*)&YpLJ), ((Tc*)&Ysgh));
   sf.pos=1549806;
   YaSM = YttT(NULL, NULL, ((Tc*)&Yd5h), 0, ((Tc*)&Yp3w));
  }
 done &= JConfig(round);
  if (round == 2001) {
  }
...
Tbs YDue() { /* MArguments.getTargetLang */
 ...
 topFrame = &sf;
 sf.pos=3076600;
 if ((YHoR((Y86c *)YX4y) && YHoR((Y86c *)Yji4)))
 {
  sf.pos=3076601;
  YFf6(((Tc*)&Yw9J), NULL, 0);
 }
 ...
 {
  sf.pos=3076603;
  VtargetLang = ((VtargetLang) & -3) | (((1) & 1) << 1);
 }
 else {
 sf.pos=3076604;
 if (YHoR((Y86c *)Yji4))
 {
  sf.pos=3076605;
  VtargetLang = ((VtargetLang) & -5) | (((1) & 1) << 2);
 }
 else
 {
  sf.pos=3076606;
  VtargetLang = ((VtargetLang) & -2) | (((1) & 1));
 }
 }
 sf.pos=3076607;
 r = VtargetLang;
...
void YCrZ(Tbs AtargetLang) { /* MArguments.parse */
 ...
 sf.pos=5636004;
 Yg2T = (ZstringCmp(YtgL(0), ((Tc*)&YwNh)) == 0);
 sf.pos=5636005;
 if ((Yd2Z() > (((Yg2T) ? (2) : (1)))))
 {
  sf.pos=5636006;
 ...
 YHc7 = YtgL(((Yg2T) ? (1) : (0)));
 sf.pos=5636008;
 if ((ZstringCmp(ZstringSliceWrap(YHc7, -3, -1), ((Tc*)&YYv4)) != 0))
 {
  sf.pos=5636009;
  YFf6(ZcS(((Tc*)&YaK9), YHc7), NULL, 0);
 }
 sf.pos=5636010;
 Yqnv = ZstringSliceWrap(YHc7, 0, -4);
 sf.pos=5636011;
 Y1Nd = YKFh(Yqnv);
 sf.pos=5636012;
 YYZY = YkNL(Yqnv);
 ...
 {
  sf.pos=5636017;
  YemS = Yq8a(YTTE, ZcS(Y1Nd, ((Tc*)&YL8q)));
 }
 else
 {
  sf.pos=5636018;
  YemS = Yq8a(YTTE, ZcS(Y1Nd, ((Tc*)&Yula)));
 }
 }
 sf.pos=5636019;
 Yy7_ = Yq8a(YTTE, ZcS(YKFh(Yqnv), ((Tc*)&YGhR)));
 sf.pos=5636020;
 if ((YszV() != 1))
 {
  sf.pos=5636021;
...
int JArguments(int round) {
 ...
 if (round == 1) {
   sf.pos=2055000;
   Y_nT = YOHU(NULL, ((Tc*)&YCLg));
  }
 done &= JCommonFlags(round);
  if (round == 2001) {
  }
  topFrame = sf.prev;
 }
...
Tl *YfV4(Tb AwithDir) { /* matchingClasses */
 ...
 sf.pos=9035401;
 {
  ...
  if (YG_U(Vf, ((Tc*)&YTpk)))
  {
   Ti VrootIdx;
   sf.pos=9035403;
   VrootIdx = ZstringFind(Vf, Y1Nd, 0);
   sf.pos=9035404;
   if (((VrootIdx == 0) || (((VrootIdx > 0) && (ZstringGetChar(Vf, (VrootIdx - 1)) == 47)))))
   {
    sf.pos=9035405;
    if (AwithDir)
    {
     sf.pos=9035406;
     ZLap((Tl*)Vl, (Tz)(void*)Yq8a(YTTE, Vf));
    }
    else
    {
     sf.pos=9035407;
     ZLap((Tl*)Vl, (Tz)(void*)Vf);
    }
   }
  }
  sf.pos=9035408;
...
int ZglobInit(int round) {
 ...
 if (round == 1) {
   sf.pos=1;
   Vexecute = ((Y_SI *)Znip(&Y_SI__T, 0, (Y_SI__Y836((Y_SI *)YSFa(NULL, ((Tc*)&Y4a), ((Tc*)&Y51N), ZnewList((Tt*)&string__T, 0), ((Tc*)&YRPH)), ((Tc*)&YSn9)))));
   sf.pos=2;
   VforceCompileFlag = YttT(NULL, ((Tc*)&YNa), ((Tc*)&Y9DS), 0, ((Tc*)&YgAr));
   sf.pos=4;
   Vprogname = ((YzqH *)Znip(&YzqH__T, 3, (YzqH__Y836((YzqH *)YBtk(NULL, ((Tc*)&YWa), ((Tc*)&Y51k), ((Tc*)&Ya), ((Tc*)&YYnK)), ((Tc*)&Y7wp)))));
   sf.pos=6;
   Vzimbu = ((YzqH *)Znip(&YzqH__T, 5, (YzqH__Y836((YzqH *)YBtk(NULL, NULL, ((Tc*)&Ye5c), ((Tc*)&Ya), ((Tc*)&Y1Xm)), ((Tc*)&YFpt)))));
   sf.pos=8;
   Vinterpreter = ((YzqH *)Znip(&YzqH__T, 7, (YzqH__Y836((YzqH *)YBtk(NULL, NULL, ((Tc*)&Yoy8), ((Tc*)&Y6Qt), ((Tc*)&Yzy5)), ((Tc*)&Yoy8)))));
 }
 done &= JIOModule(round);
 done &= JLOGModule(round);
 done &= JARGModule(round);
 done &= JArguments(round);
  if (round == 2001) {
 }
 topFrame = sf.prev;
 return done;
...
int Fmain(void) {
 ...
 Tc *Vzimbu2c = NULL;
 YPto *VfileInfo = 0;
 Tc *VcompilerResult = NULL;
 YPto *Vbefore = 0;
 Tc *VcompilerCmd = NULL;
 YPto *Vafter = 0;
 Tc *VjarCmd = NULL;
 YjUM *Vsw = 0;
 Tl *Zf2 = NULL;
 ...
 YCrZ(VtargetLang);
 sf.pos=527002;
 VexeSuffix = (((((VtargetLang) & 2) >> 1)) ? (((Tc*)&Yh63)) : ((((((VtargetLang) & 4) >> 2)) ? (((Tc*)&YTpk)) : (YiNl))));
 sf.pos=527003;
 if (YzqH__Y8Dq((YzqH *)Vprogname))
 {
  sf.pos=527004;
  VrootName = YPoi((YzqH *)Vprogname);
  sf.pos=527005;
  VprogName = VrootName;
  sf.pos=527006;
  if (((ZbyteStringSize(YiNl) != 0) && !(ZstringEndsWith(ZstringToLower(VprogName), ZstringToLower(VexeSuffix), 0))))
  {
   sf.pos=527007;
   VprogName =  ZcS(VprogName, VexeSuffix);
  }
 }
 else
 {
  ...
  VrootName = Yqnv;
  sf.pos=527009;
  VprogName = ZcS(VrootName, VexeSuffix);
 }
 Vbuild = 0;
 sf.pos=527010;
 if ((!(Y_SI__Y8Dq((Y_SI *)Vexecute)) || Y86c__Y8Dq((Y86c *)VforceCompileFlag)))
 {
  sf.pos=527011;
  Vbuild = 1;
 }
 ...
 {
  sf.pos=527017;
  if (YzqH__Y8Dq((YzqH *)Vzimbu))
  {
   sf.pos=527018;
   Vcmd = YPoi((YzqH *)Vzimbu);
  }
  else
  {
   sf.pos=527019;
  ...
  if ((Vretval == 0))
  {
   ...
   {
    sf.pos=527032;
    Yl0k(ZcS3(((Tc*)&Y27a), (((((VtargetLang) & 2) >> 1)) ? (((Tc*)&YFOs)) : ((((((VtargetLang) & 4) >> 2)) ? (((Tc*)&Y0V3)) : (((Tc*)&Yea))))), ((Tc*)&Yj_q)));
    sf.pos=527033;
    Vretval = 1;
   }
  }
  ...
  sf.pos=527035;
  if (((Vretval == 0) && !((((VtargetLang) & 2) >> 1))))
  {
   sf.pos=527036;
   VcompilerResult = VprogName;
   sf.pos=527037;
   if ((((VtargetLang) & 4) >> 2))
   {
    sf.pos=527038;
    ...
    sf.pos=527041;
    VcompilerResult = Yq8a((t0 = YTTE), ZcS(Y1Nd, ((Tc*)&YTpk)));
   }
   sf.pos=527042;
   Yb8K(VcompilerResult);
   sf.pos=527043;
   Vbefore = YPwr(VcompilerResult);
   sf.pos=527044;
   VcompilerCmd = YEL8(YemS, VprogName, VtargetLang);
   sf.pos=527045;
   if ((((VtargetLang) & 1)))
   {
    sf.pos=527046;
    VcompilerCmd =  ZcS(VcompilerCmd, Yvnf(YDJh(Yy7_), 10, 32));
    sf.pos=527047;
    if ((YE4f != NULL))
    {
     sf.pos=527048;
     VcompilerCmd =  ZcS(VcompilerCmd, ZcS(((Tc*)&YG), YE4f));
    }
   }
   sf.pos=527049;
   YDY4(ZcS(((Tc*)&Y1n5), VcompilerCmd), NULL, 0);
   sf.pos=527050;
   Vretval = YMso(VcompilerCmd);
   sf.pos=527051;
   Vafter = YPwr(VcompilerResult);
   sf.pos=527052;
   if ((Vafter->Vsize == 0))
   {
    sf.pos=527053;
    YDli(ZcS3(((Tc*)&YQ7I), VcompilerResult, ((Tc*)&YtjG)), NULL, 0);
    sf.pos=527054;
    Vretval = 1;
   }
   else {
   ...
   {
    sf.pos=527056;
    YDli(ZcS3(((Tc*)&YQ7I), VcompilerResult, ((Tc*)&YBGg)), NULL, 0);
    sf.pos=527057;
    Vretval = 1;
   }
   else {
  ...
  sf.pos=527060;
  if (((Vretval == 0) && (((VtargetLang) & 4) >> 2)))
  {
   sf.pos=527061;
   VjarCmd = YRe9(VrootName, YfV4(0));
   sf.pos=527062;
   YDY4(ZcS3(((Tc*)&Ym5P), YuALa(VjarCmd, 0, 60), ((Tc*)&Y_y2)), NULL, 0);
   sf.pos=527063;
   Vretval = YMso(VjarCmd);
  }
 }
 sf.pos=527064;
 if (((Vretval == 0) && ((Y_SI__Y8Dq((Y_SI *)Vexecute) || Yg2T))))
 {
  sf.pos=527065;
  Vsw = Zamt(sizeof(YjUM), YjUM__mt);
  sf.pos=527066;
  if (YzqH__Y8Dq((YzqH *)Vinterpreter))
  {
   sf.pos=527067;
   YJqza((YjUM *)Vsw, YPoi((YzqH *)Vinterpreter));
   sf.pos=527068;
   YJqza((YjUM *)Vsw, ((Tc*)&YG));
  }
  sf.pos=527069;
  if ((((VtargetLang) & 4) >> 2))
  {
   sf.pos=527070;
   YJqza((YjUM *)Vsw, ZcS5(((Tc*)&YmdT), VrootName, ((Tc*)&Yj1q), (t0 = VrootName), (Tc*)1));
  }
  else
  {
   sf.pos=527071;
   ...
   sf.pos=527073;
   YJqza((YjUM *)Vsw, VprogName);
  }
  sf.pos=527074;
  {
   Tfl Zf2i;
   Zf2 = YEKc((Y_SI *)Vexecute);
   Zf2i.l = Zf2;
   Zf2i.valp = (void*)&Varg;
   Zf2i.i = 0;
   for (; ZforListPtrCont(&Zf2i); ) {
   sf.pos=527075;
   YJqza((YjUM *)Vsw, ZcS3(((Tc*)&Y5Y), Varg, ((Tc*)&YN)));
   sf.pos=527076;
   }
  }
  sf.pos=527077;
  Vcmd1 = YbNW((YjUM *)Vsw);
  sf.pos=527078;
  YDY4(ZcS3(((Yg2T) ? (((Tc*)&Yyp1)) : (((Tc*)&YfLG))), ((Tc*)&YFDa), (t0 = Vcmd1)), NULL, 0);
  sf.pos=527079;
  Vretval = YMso(Vcmd1);
  sf.pos=527080;
  if ((Vretval != 0))
