/*
 * Generated from Zimbu file zimb/animal.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
/* IOModule done */
typedef struct YXWw__S YXWw; /* Animal */
typedef struct YkR8__S YkR8; /* Wolf */
typedef struct YkDR__S YkDR; /* Fish */
typedef struct YgCY__S YgCY; /* GoldFish */
typedef struct YmeD__S YmeD; /* OtherAnimal */
/*
 * STRUCTS
 */
/* IO.eof */
...
/* IOModule done */
void Ylnu(YXWw *t); /* CAnimal.eat */
Zs30 Y2aP = {"\034I eat like a generic Animal.\000"};
Tc *YXWw__YXWw_I_imt[3];
To ToYXWw[1];
Zs8 YTCK = {"\006Animal\000"};
void YJc3a(YkR8 *t); /* CWolf.eat */
Zs20 YFf5 = {"\022I eat like a wolf!\000"};
Tc *YkR8__YXWw_I_imt[3];
To ToYkR8[1];
Zs6 YKhc = {"\004Wolf\000"};
void YJEPa(YkDR *t); /* CFish.eat */
Zs20 YFOS = {"\022I eat like a fish!\000"};
Tc *YkDR__YXWw_I_imt[3];
To ToYkDR[1];
Zs6 YK3U = {"\004Fish\000"};
void YcLIa(YgCY *t); /* CGoldFish.eat */
Zs24 YpXw = {"\026I eat like a goldfish!\000"};
Tc *YgCY__YXWw_I_imt[3];
To ToYgCY[1];
Zs10 YAVh = {"\010GoldFish\000"};
void YmeD__Ylnu(YmeD *t); /* COtherAnimal.eat__p1 */
Tc *YmeD__YXWw_I_imt[3];
To ToYmeD[1];
Zs13 YYSC = {"\013OtherAnimal\000"};
...
Tc Y2xT[]="/usr/bin/lib/EModule.zu";
Tc YQk7[]="/usr/bin/lib/IOModule.zu";
Tc YbpE[]="/usr/bin/lib/TIMEModule.zu";
Tc Y8QL[]="/usr/bin/lib/ZModule.zu";
Tc YfFw[]="zimb/animal.zu";
Tc YL0u[]="Animal.eat()";
Tcpos ZcTbl33803[]={
{6,9},
{1,5},
...
Tcode ZcodeTable[]={
{1872,YQk7,YNFk,ZcTbl1872},
{5270,YfFw,Y9QD,ZcTbl5270},
{6308,Y2xT,YR5_,ZcTbl6308},
{7452,YQk7,Ys1a,ZcTbl7452},
{11217,Y2xT,YoZS,ZcTbl11217},
{13265,YfFw,Y6R4,ZcTbl13265},
{15718,Y2xT,YEFs,ZcTbl15718},
{18187,Y8QL,Ym1t,ZcTbl18187},
{21418,Y2xT,YtpQ,ZcTbl21418},
{25958,Y2xT,Y4vu,ZcTbl25958},
{32086,Y2xT,Y1As,ZcTbl32086},
{33803,YfFw,YL0u,ZcTbl33803},
{34095,YfFw,Ykyk,ZcTbl34095},
{35088,Y2xT,YcIS,ZcTbl35088},
{36159,Y2xT,Y_4w,ZcTbl36159},
{36491,Y2xT,YYT9,ZcTbl36491},
{42983,Y2xT,Y9aV,ZcTbl42983},
{44130,Y2xT,YG80,ZcTbl44130},
{45289,Y2xT,Y7gV,ZcTbl45289},
{46171,Y2xT,Y9VX,ZcTbl46171},
{46761,YQk7,YN2v,ZcTbl46761},
{47021,YfFw,YP8B,ZcTbl47021},
{48299,Y2xT,Y9Cv,ZcTbl48299},
{49183,Y2xT,YgcH,ZcTbl49183},
{50841,YbpE,YLwM,ZcTbl50841},
{52386,Y2xT,YgcM,ZcTbl52386},
{53377,Y2xT,Yp81,ZcTbl53377},
{54331,Y2xT,YLzZ,ZcTbl54331},
{56372,Y2xT,Y4u_,ZcTbl56372},
{59819,YQk7,YGQL,ZcTbl59819},
{60593,Y2xT,Y5LR,ZcTbl60593},
{64531,YQk7,YrJP,ZcTbl64531},
{72007,YQk7,YzQB,ZcTbl72007},
{73471,Y2xT,Y_Qs,ZcTbl73471},
{73580,Y2xT,YF6S,ZcTbl73580},
{80644,Y2xT,YobA,ZcTbl80644},
{82618,YQk7,Yxlj,ZcTbl82618},
{86818,Y2xT,YlgI,ZcTbl86818},
{87235,Y2xT,YR5m,ZcTbl87235},
{89685,Y2xT,Y59h,ZcTbl89685},
{89987,YQk7,YCbR,ZcTbl89987},
{92163,Y2xT,YTjU,ZcTbl92163},
{94823,YQk7,Yj_J,ZcTbl94823},
{96107,Y2xT,YMF2,ZcTbl96107},
{97019,Y2xT,YgQK,ZcTbl97019},
{97784,YfFw,Y9bp,ZcTbl97784},
{99886,Y2xT,Y0Jk,ZcTbl99886},
};
...
Tc *YXWw__YXWw_I_imt[] = {
 (Tc*)&YXWw__T,
 (Tc*)Ylnu, /* CAnimal.eat - Ylnu */
 (Tc*)0, /* Init - YXWwa */
};
To ToYXWw[] = {
 {0, 0},
};
Tto YXWw__T = {390, (Tc*)&YTCK, 0, ToYXWw};
void YJc3a(YkR8 *t) {
 Zsf sf;
 sf.prev = topFrame;
 sf.pos = 0;
...
Tc *YkR8__YXWw_I_imt[] = {
 (Tc*)&YkR8__T,
 (Tc*)YJc3a, /* CWolf.eat - YJc3a */
 (Tc*)0, /* Init - YkR8a */
};
To ToYkR8[] = {
 {0, 0},
};
Tto YkR8__T = {390, (Tc*)&YKhc, 0, ToYkR8};
void YJEPa(YkDR *t) {
 Zsf sf;
 sf.prev = topFrame;
 sf.pos = 0;
...
Tc *YkDR__YXWw_I_imt[] = {
 (Tc*)&YkDR__T,
 (Tc*)YJEPa, /* CFish.eat - YJEPa */
 (Tc*)0, /* Init - YkDRa */
};
To ToYkDR[] = {
 {0, 0},
};
Tto YkDR__T = {390, (Tc*)&YK3U, 0, ToYkDR};
void YcLIa(YgCY *t) {
 Zsf sf;
 sf.prev = topFrame;
 sf.pos = 0;
...
Tc *YgCY__YXWw_I_imt[] = {
 (Tc*)&YgCY__T,
 (Tc*)YcLIa, /* CGoldFish.eat - YcLIa */
 (Tc*)0, /* Init - YgCYa */
};
To ToYgCY[] = {
 {0, 0},
};
Tto YgCY__T = {390, (Tc*)&YAVh, 0, ToYgCY};
void YmeD__Ylnu(YmeD *t) {
 Zsf sf;
 sf.prev = topFrame;
 sf.pos = 0;
 topFrame = &sf;
...
Tc *YmeD__YXWw_I_imt[] = {
 (Tc*)&YmeD__T,
 (Tc*)YmeD__Ylnu, /* COtherAnimal.eat - YmeD__Ylnu */
 (Tc*)0, /* Init - YmeDa */
};
To ToYmeD[] = {
 {0, 0},
};
Tto YmeD__T = {390, (Tc*)&YYSC, 0, ToYmeD};
/*
 * INIT IMT
 */
void ZimtInit(void) {
...
int Fmain(void) {
 ...
 r = 0;
 sf.pos=527000;
 Vanimals = ZnewList((Tt*)&iobj__T, 0);
 sf.pos=527001;
 ZLapIobj((Tl*)Vanimals, *Znao(&t0, Za(sizeof(YXWw)), YXWw__YXWw_I_imt, 0));
 sf.pos=527002;
 ZLapIobj((Tl*)Vanimals, *Znao(&t0, Za(sizeof(YkR8)), YkR8__YXWw_I_imt, 1));
 sf.pos=527003;
 ZLapIobj((Tl*)Vanimals, *Znao(&t0, Za(sizeof(YkDR)), YkDR__YXWw_I_imt, 2));
 sf.pos=527004;
 ZLapIobj((Tl*)Vanimals, *Znao(&t0, Za(sizeof(YgCY)), YgCY__YXWw_I_imt, 3));
 sf.pos=527005;
 ZLapIobj((Tl*)Vanimals, *Znao(&t0, Za(sizeof(YmeD)), YmeD__YXWw_I_imt, 4));
 sf.pos=527006;
 {
  Tfl Zf1i;
  Zf1 = Vanimals;
  Zf1i.l = Zf1;
  Zf1i.valp = (void*)&Vanimal;
  Zf1i.i = 0;
  for (; ZforListIobjCont(&Zf1i); ) {
  sf.pos=527007;
  ((void (*)(void*))(Vanimal.table[1]))(Vanimal.ptr);
  sf.pos=527008;
  }
 }
 sf.pos=527009;
